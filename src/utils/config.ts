...
function validateConfig(): ConfigFields {
  if (!process.env["BOT_TOKEN"] || !process.env["CHANNEL_ID"] || !process.env["POOL_ID"] || !process.env["ACCOUNT_ID"] || !process.env["NODE_METRICS_URL"]) {
    ...
    return {
      ...
      nodeMetricsUrl: process.env["NODE_METRICS_URL"],
